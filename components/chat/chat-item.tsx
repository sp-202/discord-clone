...
export const ChatItem = ({
    ...
    const [fileType = "", fileURL = ""] = fileUrl?.split("|") ?? [];
                ...
                <div className="flex flex-col w-full">
                    ...
                    {isImage && (
                        <a
                            ...
                            className="relative aspect-square rounded-md mt-2 overflow-hidden border items-center bg-secondary h-48 w-48"
                        >
                            <Image
                                src={fileURL}
                                alt={content}
                    ...
                    {!fileUrl && !isEditing && (
                        <p className={cn(
                            ...
                            deleted && "italic text-zinc-500 dark:text-zinc-400 text-xs mt-2"
                        )}>
                            {content}
                            {isUpdated && !deleted && (
